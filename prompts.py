...
CULTURAL CONTEXT: The protagonists are mainland Chinese professionals or families living in the San Francisco Bay Area. Names, cultural references, and social details should reflect mainland Chinese background. Use WeChat rather than LINE for messaging. Avoid Taiwan-specific settings such as 7-Eleven convenience stores or community bulletin boards — favour supermarkets, office parks, suburban homes, and Chinese community churches typical of the Bay Area.
